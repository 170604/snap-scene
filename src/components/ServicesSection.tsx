...
import { Heart, Baby, Users, PartyPopper, Plane, Utensils, Home, Package, Calendar, Video, ChevronLeft, ChevronRight, ArrowRight } from "lucide-react";
    ...
    <div className="py-20 bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-creative text-lg mb-4 font-medium">
              Life Is Full Of Beautiful Moments, We Just Need To Capture Them.
            </p>
          ...
          <div className="relative">
            ...
            {/* Cards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 px-12">
              {occasionsToCapture.map((occasion, index) => (
                <Card 
                  key={index} 
                  className="group hover:shadow-creative transition-all duration-300 border-0 bg-warm-gray overflow-hidden cursor-pointer"
      ...
      <section id="business" className="bg-warm-gray py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-creative text-lg mb-4 font-medium">
              Get Better Product Appearance On Your Platform, At Scale!
            </p>
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 px-12">
              {businessOfferings.map((offering, index) => (
                <Card 
                  key={index} 
                  className="group hover:shadow-creative transition-all duration-300 border-0 bg-background overflow-hidden cursor-pointer"
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold text-primary mb-4">All Our Services</h3>
            <div className="flex flex-wrap justify-center gap-3">
              {[...occasionsToCapture, ...businessOfferings].map((service, index) => (
